...
1. DevOps Setup & CI/CD + Hello World
2. Foundation & Tooling
3. Supabase Setup (Auth + DB)
4. Domain Model & Migrations
5. Question Bank & Rotation Algorithm
6. Daily Quiz UI (Swipe)
7. Personality Calculation Engine (7‑day window)
8. Streak System
9. Dashboard & Personality Display
10. Theming, Icons, Animations
11. Deployment (Dokploy) & Env Management
12. QA: Tests & Observability
13. Phase 2: Historical Charts (@unovis/vue)
14. Progress Tracker Markdown
...
* [ ] `responses` (id, user\_id, question\_id, date, answer, strength)

* [ ] `daily_summaries` (user\_id, date, per-dimension aggregates)

* [ ] `profiles_weekly` (user\_id, week\_start, type, percentages)
  Indexes/Constraints
